...
import '../../templates/standart/di/dependency_injections.dart';
import '../../templates/standart/launcher/main_dev.dart';
import '../../templates/standart/launcher/main_prod.dart';
import '../../templates/standart/main_template.dart';
import '../../templates/standart/presentation/ui_template.dart';
import '../../templates/standart/shared_libraries/core/models/api_response.dart';
import '../../templates/standart/shared_libraries/utils/constants/app_constants.dart';
import '../../templates/standart/shared_libraries/core/api_interceptors.dart';
import '../../templates/standart/shared_libraries/core/dio_handler.dart';
import '../../templates/standart/shared_libraries/utils/error/exception.dart';
import '../../templates/standart/shared_libraries/utils/error/failure_response.dart';
import '../../templates/standart/shared_libraries/utils/navigation/navigation_helper.dart';
import '../../templates/standart/shared_libraries/utils/navigation/router/app_routes.dart';
import '../../templates/standart/shared_libraries/utils/navigation/router/home_router.dart';
import '../../templates/standart/shared_libraries/utils/setup/app_setup.dart';
import '../../templates/standart/shared_libraries/utils/state/view_data_state.dart';

class InitStandartGenerator {
